...
/**
 * @param RepositoryInterface<Setor> $repository
 * @implements UseCaseInterface<CountSetorUseCase, int>
 */
class CountSetorUseCase implements UseCaseInterface
{
	public function __construct(
		private SetorRepositoryInterface $repository,
	) {}
