...
class SoftDeleteEmpresaController implements ControllerInterface
{
	...
	/**
	 * Handle the request to soft delete an empresa by ID.
	 *
	 * @param Request $req
	 * @param Response $res
	 * @param?array $args
	 ...
	 */
	#[OAT\Delete(
		path: '/empresas/{id}/soft-delete',
		tags: ['Empresas'],
		operationId: 'softDeleteEmpresa',
