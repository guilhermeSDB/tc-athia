...
class DeleteSetorController implements ControllerInterface
{
	...
	/**
	 * Handle the request to delete an setor by ID.
	 *
	 * @param Request $req
	 * @param Response $res
	 * @param?array $args
	...
	#[OAT\Delete(
		...
		description: 'Deleta uma setor pelo ID',
		parameters: [
			new OAT\Parameter(
				name: 'id',
				in: 'path',
				required: true,
				description: 'ID da Setor a ser deletada',
		...
		responses: [
			...
			new OAT\Response(
				response: 400,
				description: 'Erro ao tentar excluir a setor, setor não encontrada ou não pode ser excluído',
